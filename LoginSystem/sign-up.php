			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					...
					<form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="fh5co-form animate-box" data-animate-effect="fadeIn">
						<h2>Sign Up</h2>
						<p style="color: red"><?php echo isset($_SESSION['exist-username']) ? $_SESSION['exist-username'] : "" ?></p>
						<div class="form-group">
							<label for="name" class="sr-only">Name</label>
							<input type="text" class="form-control" name="username" id="name" placeholder="Name" autocomplete="off">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<input type="submit" name="sign-up" value="Sign Up" class="btn btn-primary">
						</div>
					</form>
					<!-- END Sign In Form -->
