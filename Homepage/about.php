		...
		<div class="container">
			...
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center heading-section">
					<h3>Who Am I</h3>
					<p>Hi, I'm Dương Nguyễn Minh Thông who author of this project. Currently a 4 years student at Van Lang University</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="fh5co-started">
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Contact Me</h2>
					<p>Email: minhthongduongnguyen7@gmail.com</p>
					<p>Phone number: 0902848635</p>
					<p>Zalo: 0902848635</p>
				</div>
			</div>
		</div>
